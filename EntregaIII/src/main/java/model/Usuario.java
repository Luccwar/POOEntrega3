...
public class Usuario extends Pessoa {
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(email, endereco, id, login, renda, senha);
		return result;
	}
	...
	public String toString() {
		return "Usuario [id=" + id + ", login=" + login + ", email=" + email + ", senha=" + senha + ", endereco="
				+ endereco + ", renda=" + renda + "]";
	}
